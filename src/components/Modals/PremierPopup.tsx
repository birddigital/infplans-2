                        ...
                        <div id="plans-section-6">
                           <div className="d-flex">
                              ...
                              <div className="tab-content p-3 w-100 pb-5">
                                             ...
                                             <nav>
                                                <ul>
                                                   <li className="coverages-tabone">
                                                      <label for="coverages-tabone">INF Premium Plan <br/> <span className="text-black age-title">Age 0-69</span></label>
                                                   </li>
                                                   <li className="coverages-tabtwo">
                                                      <label for="coverages-tabtwo">INF Premium Plan <br/> <span className="text-black age-title">Age 70-99</span></label>
                                                   </li>
                                                </ul>
                                             </nav>
                                             <section>
                                                   ...
                                                   <div className="row">
                                                     <div className="col-lg-4">
                                                       <div className="column-tab">
                                                         <p className="text-white column-tab-titles">Deductible Per Covered Accident or Sickness Expense</p>
                                                       </div>
                                 ...
                                 <div id="ivas-benefits" className={premierBenefitsVisible ? "tab-pane fade active show" : "tab-pane fade show" } role="tabpanel" aria-labelledby="ivas-benefits">
                                    <div className="tabcontent">
                                       <div className="col-lg-12 ivas-standard">
                                             ...
                                             <nav>
                                                <ul>
                                                   <li className="ivas-in-tabone">
                                                      <label for="ivas-in-tabone">100k Premier | Medical Out-Patient Benefits (Services Rendered Require Less Than 24 Hours Stay)<br/> Age 0-99</label>
                                                   </li>
                                                   <li className="ivas-in-tabtwo">
                                                      <label for="ivas-in-tabtwo">100k Premier  | ​Medical in-Patient Benefits (Services Rendered Require More Than 24 Hours Stay) <br/> Age 0-99</label>
                                                   </li>
                                                   <li className="ivas-in-tabthree">
                                                      <label for="ivas-in-tabthree">100k Premier | Other Covered Services <br/> Age 0-99</label>
                                                   </li>
                                                </ul>
                                             </nav>
                                             <section>
                                             ...
                                             <nav>
                                                <ul>
                                                   <li className="ivas-out-tabone">
                                                      <label for="ivas-out-tabone">150k Premier | Medical in-Patient Benefits (Services Rendered Require More Than 24 Hours Stay)<br/> Age 0-69</label>
                                                   </li>
                                                   <li className="ivas-out-tabtwo">
                                                      <label for="ivas-out-tabtwo">150k Premier | Medical Out-Patient Benefits (Services Rendered Require Less Than 24 Hours Stay)<br/> Age 0-69</label>
                                                   </li>
                                                   <li className="ivas-out-tabthree">
                                                      <label for="ivas-out-tabthree">150k Premier | Other Covered Services<br/> Age 0-69</label>
                                                   </li>
                                                </ul>
                                             </nav>
                                             <section>
