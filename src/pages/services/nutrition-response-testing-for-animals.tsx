...
const NutritionResponsePage: React.FC<Props> = ({ data, location }: Props) => {
  ...
  return (
    <Layout location={location}>
      <Meta site={meta} title="Nutrition Response Testing for animals" />
      <section id="hero-section" class="hero-section">
        <Container>
          <div className="col-lg-6">
            <h1 className="text-black font-55">
...
export default NutritionResponsePage

export const query = graphql`
  query NutritionResponsePageQuery {
