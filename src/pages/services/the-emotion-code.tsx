...
const TheEmotionCodePage: React.FC<Props> = ({ data, location }: Props) => {
  ...
  return (
    <Layout location={location}>
      <Meta site={meta} title="The Emotion Code" />
...
export default TheEmotionCodePage

export const query = graphql`
  query TheEmotionCodePageQuery {
