...
const WholeFoodSupplementsPage: React.FC<Props> = ({ data, location }: Props) => {
  ...
  return (
    <Layout location={location}>
      <Meta site={meta} title="Whole Food Supplements" />
...
export default WholeFoodSupplementsPage

export const query = graphql`
  query WholeFoodSupplementsPageQuery {
