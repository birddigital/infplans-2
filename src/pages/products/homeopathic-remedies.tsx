...
const HomeopathicRemediesPage: React.FC<Props> = ({ data, location }: Props) => {
  ...
  return (
    <Layout location={location}>
      <Meta site={meta} title="Homeopathic Remedy" />
...
export default HomeopathicRemediesPage

export const query = graphql`
  query HomeopathicRemediesPageQuery {
