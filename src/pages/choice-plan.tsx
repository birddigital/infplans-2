...
const ChoicePlanPage: React.FC<Props> = ({ data, location }: Props) => {
  ...
  return (
    <Layout location={location}>
      ...
      <BackgroundImage
        Tag="section"
        className="choice-plan-faq-hero-section-bg"
        fluid={hero_background}
        backgroundColor={`#e9f4f8`}
        alt="choice plan faq-hero background"
      >
        <div id="choice-plan-faq-hero-section">
          <Container>
      ...
      <section id="choice-plan-faq">
        <Container>
          <div className="col-lg-12">
            <div className="choice-plan-faq-container">
              <h2 className="text-blue text-center">INF Choice Plan: Frequently Asked Questions</h2>

              <p className="title">Who is eligible for the INF Choice Plan?</p>
              <p>Any Non-US Citizen traveling to the United States can apply for the INF Choice Plan. This includes Green Card holders, H-1B Visa Holders, Permanent Residents, Students on F1 / F1 Visas, those on OTP, and those whose immigration status is not confirmed. This plan works for all age groups, from age 0 to age 99+.</p>

              <p className="title">Will the INF Choice cover Travel?</p>
              <p>The Choice Plan covers travel through any stop over. Whether you are transiting through Dubai, London, or Hong Kong, you will have coverage throughout your journey. Travel with confidence, provided by INF.</p>
              ...
              <p>Yes. The Choice Plan works in all 50 states. There is no need to worry when you are traveling with an INF Plan. The Choice Plan offers the option of using the First Health Provider Network. Find a full list of providers <a href="https://www.firsthealthinternational.com/LocateProvider/CustomPage">here.</a></p>

              <p className="title">Why should I purchase the INF Choice Plan?</p>
              <p>The INF Choice Plan is an affordable insurance option for visitors. The Choice Plan covers medical events and In-Patient, emergency hospitalizations for both New Accident & Sicknesses & Acute Onset of pre-existing conditions. The Choice Plan is a great option for individuals seeking to mitigate the risk of a large medical bill burdening your family. The Choice Plan provides excellent coverage & will protect your family when the time comes.</p>

              <p className="title">What's the minimum enrollment for the Choice Plan?</p>
              ...
              <p className="title">What is my Co-Pay with this Plan?</p>
              <p>Choice has a $0 Copay when using the <Link to="/telemedicine-visitors-insurance">Teladoc Telemedicine</Link> benefit provided with the plan. All other medical services rendered are subject to a deductible, which must be met before the policy will pay any benefit as per the schedule of benefits listed in the plan brochure.</p>

              <p className="title">How do I pay for this Plan?</p>
              <p>INF accepts all major credit card for for payment (Visa, Discover, Mastercard, American Express). Checks and Money Orders are also accepted with a paper application.</p>

              <p className="title">Who underwrites the Choice Plan?</p>
              <p>AXIS Insurance Company, Chicago, IL is the underwriter for the Choice Plan. INF only uses American Underwriters to protect policyholders. INF policies are regulated by the State Insurance authority.</p>

              <p className="title">Where can I use this Plan?</p>
              <p>The Choice Plan can be used with the First Health Provider Network option which provides access to discounted health care services from one of the largest medical networks in the U.S. No longer will you need to pay hospital bills upfront & then submit claims forms, waiting sometimes months for reimbursement. Instead, the health care provider will bill the insurance directly after applying the discounted rate.</p>

              <p className="title">Are the Choice Plan's Premiums Pro-Rated?</p>
              ...
              <p className="title">Can I renew the Choice Plan?</p>
              <p>You are able to renew the Choice Plan for any amount of time after the initial coverage period. We send email, text, and phone call reminders to you 1 week & 1 day before the policy expiration.</p>

              <p className="title">Will this plan cover pre-existing conditions?</p>
              <p>The Choice Plan does covers acute on-set of  pre-existing conditions. We recommend individuals above 50 years of age who have any mild pre-existing conditions enroll in this program.</p>
...
export default ChoicePlanPage

export const query = graphql`
  query ChoicePlanPageQuery {
    site {
      meta: siteMetadata {
        title
        description
